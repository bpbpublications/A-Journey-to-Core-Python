...
Original file is located at
    https://colab.research.google.com/drive/1YPerHYWN3thHIiz7l6G18NNXIj1JaxaM
"""
...
# hasattr(ob1, 'age')    # Returns true if 'age' attribute exists 
...
# Program to find area of rectangle using classes
# a.	class rect:
# b.	def __init__(self,breadth,length):
# c.	self.breadth=breadth
# d.	self.length=length
...
# Program to check whether a class is subclass of another
# a.	classBase(object):
# b.	    pass   # Empty Class
# c.	 
# d.	classDerived(Base):
